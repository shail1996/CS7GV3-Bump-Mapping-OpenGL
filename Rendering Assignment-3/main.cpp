...
void init(void) {
	...
	// Cube Map
	SkyBoxShaderProgramID = CompileShaders("C:/Users/lenovo/source/repos/Rendering Assignment-3/Shaders/sbVS.txt",
		"C:/Users/lenovo/source/repos/Rendering Assignment-3/Shaders/sbFS.txt");
	generateObjectBuffer(SkyBoxShaderProgramID);

	// Mapping Shader
	ShaderProgramID = CompileShaders("C:/Users/lenovo/source/repos/Rendering Assignment-3/Shaders/objectVS.txt",
		"C:/Users/lenovo/source/repos/Rendering Assignment-3/Shaders/objectFS.txt");
	generateObjectBuffer(ShaderProgramID);

	CreateCubeMap("C:/Users/lenovo/source/repos/Rendering Assignment-3/Skybox/learnopengl/negz.jpg",
		"C:/Users/lenovo/source/repos/Rendering Assignment-3/Skybox/learnopengl/posz.jpg",
		"C:/Users/lenovo/source/repos/Rendering Assignment-3/Skybox/learnopengl/posy.jpg",
		"C:/Users/lenovo/source/repos/Rendering Assignment-3/Skybox/learnopengl/negy.jpg",
		"C:/Users/lenovo/source/repos/Rendering Assignment-3/Skybox/learnopengl/negx.jpg",
		"C:/Users/lenovo/source/repos/Rendering Assignment-3/Skybox/learnopengl/posx.jpg", &textureID);
...
void display(void) {
	...
	// Binding Textures Start!
	if (imageLoadFlag == 0) {
		// Load the texture
		DiffuseTexture = TextureFromFile("image/steel.jpg");
		NormalTexture = TextureFromFile("image/normal.png");
		SpecularTexture = TextureFromFile("image/specular.png");
		imageLoadFlag++;
	}

	// Get a handle for our "myTextureSampler" uniform
	GLuint DiffuseTextureID = glGetUniformLocation(ShaderProgramID, "DiffuseTextureSampler");
	GLuint NormalTextureID = glGetUniformLocation(ShaderProgramID, "NormalTextureSampler");
	GLuint SpecularTextureID = glGetUniformLocation(ShaderProgramID, "SpecularTextureSampler");
	...
	// Binding Textures Done!

	// Light Value
	glm::vec3 lightPos = glm::vec3(lightPosx, lightPosy, lightPosz);
	//glm::vec3 lightPos = glm::vec3(5.7, 0.0, 3.7);
	...
	GLuint ModelView3x3MatrixID = glGetUniformLocation(ShaderProgramID, "MV3x3");
	...
	//glm::mat4 ProjMatrix = glm::perspective(objSize, (float)width / (float)height, 0.5, 50.0);
...
void keyPress(unsigned char key, int xmouse, int ymouse) {
	...
	case ('7'):
		lightPosx += 0.5;
		std::cout << lightPosx << "Keypress: " << key << std::endl;
		break;
	case ('4'):
		lightPosx -= 0.5;
		std::cout << lightPosx << "Keypress: " << key << std::endl;
	...
	case ('8'):
		lightPosy += 0.5;
		std::cout << lightPosy << "Keypress: " << key << std::endl;
		break;
	case ('5'):
		lightPosy -= 0.5;
		std::cout << lightPosy << "Keypress: " << key << std::endl;
	...
	case ('9'):
		lightPosz += 0.5;
		std::cout << lightPosz << "Keypress: " << key << std::endl;
		break;
	case ('6'):
		lightPosz -= 0.5;
		std::cout << lightPosz << "Keypress: " << key << std::endl;
